...
function ResetRequestFields() {
    ...
    dojo.byId('txtAddressField').value = "";
...
function BlurTextIsos() {
    ...
    dojo.byId("txtAddressField").blur();
...
function SubmitIssueDetails() {
    ...
    dojo.byId('txtAddressField').value = dojo.byId('txtAddressField').value.trim('');
    ...
    serviceRequestAttributes[serviceRequestFields.AddressFieldName] = dojo.byId('txtAddressField').value.trim();
